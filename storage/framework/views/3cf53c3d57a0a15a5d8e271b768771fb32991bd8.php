...
<h2 class="center">Enviar Campanha</h2>
    <div class="row">
        <nav>
            <div class="nav-wrapper green darken-1">
                ...
                <a href="<?php echo e(route('admin.principal')); ?>" class="breadcrumb">Lista de Campanhas</a>
    ...
    <div class="row">
        <form action="<?php echo e(route('admin.campanha.enviar',$campanha->id)); ?>" method="get">
          ...
          <?php echo $__env->make('admin.campanha._lista', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
