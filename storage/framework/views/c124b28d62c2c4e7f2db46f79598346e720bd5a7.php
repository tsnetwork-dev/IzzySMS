...
<div class="row">
	...
	<div class="row">
        <div class="col s12 m3">
          <div class="card green darken-1">
            ...
            <div class="card-action">
              <a class="white-text" href="<?php echo e(route('admin.campanha')); ?>">Acessar</a>
            </div>
          </div>
        </div>
        <div class="col s12 m3">
          <div class="card blue darken-1">
            ...
            <div class="card-action">
              <a class="white-text" href="<?php echo e(route('admin.chipeira')); ?>">Acessar</a>
            </div>
          </div>
        </div>
        <div class="col s12 m3">
          <div class="card orange darken-1">
            ...
            <div class="card-action">
              <a class="white-text" href="<?php echo e(route('admin.credor')); ?>">Acessar</a>
            </div>
          </div>
        </div>
        <div class="col s12 m3">
      <div class="card deep-purple ">
        ...
        <div class="card-action">
          <a class="white-text" href="<?php echo e(route('admin.posts')); ?>">Acessar</a>
        </div>
      </div>
    </div>
    <div class="col s12 m3">
