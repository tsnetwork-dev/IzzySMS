...
@section('content')
    ...
    <div class="row">
        <div class="col s12 m6">
            <a class="white-text" href="{{ route('admin.posts.lista') }}">
        ...
        <div class="col s12 m6">
                <a class="white-text" href="{{ route('admin.posts.enviadas') }}">
    ...
    <div class="row">
            <div class="col s12 m6">
                <a class="white-text" href="{{ route('admin.posts.entregas') }}">
            ...
            <div class="col s12 m6">
                    <a class="white-text" href="{{ route('admin.posts.falhas') }}">
